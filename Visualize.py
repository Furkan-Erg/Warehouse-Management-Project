...
def start():
    ...
    button = Button(frame, text="Exit", activebackground="grey25", font="Verdana 12", command=window.quit, fg="#1C1C1C",
                    bg="OrangeRed3", relief=FLAT)
    button.place(x=300, y=300)
    button2 = Button(frame, text="Start", activebackground="grey25", font="Verdana 12", command=firstframe,
                     fg="#1C1C1C", bg="OrangeRed3", relief=FLAT)
...
def firstframe():
    ...
    usedMaterials = Listbox(frame1, font="Verdana 12 bold", height=6, width=10, bg='red3')
    usedMaterials.config(yscrollcommand=scrollbar.set)
    usedMaterials.place(x=480, y=130)

    nameVar = StringVar()
    pName = Label(frame1, width=20, font="Verdana 12 bold", fg="OrangeRed3", bg="grey25", relief=FLAT,
                  textvariable=nameVar)
    pName.place(x=220, y=50)
    dopVar = StringVar()
    pDateOfProduction = Label(frame1, width=20, font="Verdana 12 bold", fg="OrangeRed3", bg="grey25", relief=FLAT,
                              textvariable=dopVar)
    pDateOfProduction.place(x=220, y=80)
    nocVar = StringVar()
    pNameOfCustomer = Label(frame1, width=20, font="Verdana 12 bold", fg="OrangeRed3", bg="grey25", relief=FLAT,
                            textvariable=nocVar)
    pNameOfCustomer.place(x=220, y=110)
    sedVar = StringVar()
    pStorageExpDate = Label(frame1, width=20, font="Verdana 12 bold", fg="OrangeRed3", bg="grey25", relief=FLAT,
                            textvariable=sedVar)
    pStorageExpDate.place(x=220, y=140)
    scVar = StringVar()
    pStorageCode = Label(frame1, width=20, font="Verdana 12 bold", fg="OrangeRed3", bg="grey25", relief=FLAT,
                         textvariable=scVar)
    pStorageCode.place(x=220, y=170)
    dVar = StringVar()
    pDescription = Label(frame1, width=38, height=5, font="Verdana 12 bold", fg="OrangeRed3", bg="grey25", relief=FLAT,
                         textvariable=dVar,
    ...
    def openImage():
        ...
        load = load.resize((300, 200), Image.LANCZOS)
    ...
    # function that opens camera
    sfbutton = Button(frame1, text="Add New Product", activebackground="grey25", font="Verdana 12", command=secondframe,
                      fg="#1C1C1C", bg="OrangeRed3", relief=FLAT)
    sfbutton.place(x=470, y=20)
    sfbutton2 = Button(frame1, text="Product Image", activebackground="grey25", font="Verdana 12", fg="#1C1C1C",
                       bg="OrangeRed3", relief=FLAT, command=openImage)
    sfbutton2.place(x=480, y=60)
    button2 = Button(frame1, text="Camera", height=3, width=10, activebackground="grey25", font="Verdana 12",
                     fg="#1C1C1C", bg="OrangeRed3", relief=FLAT, command=openCamera)
    ...
    combobox = Combobox(frame1, width=34, height=5,
                        values=(productNames(products2)))
...
def secondframe():
    ...
    pDateOfProductionLabel = Label(frame2, text="Date of Production", font="Verdana 12 bold", fg="OrangeRed3",
                                   bg="#1C1C1C")
    ...
    pDescription = Entry(frame2, width=38, font="Verdana 12 bold", fg="OrangeRed3", bg="grey25", relief=FLAT,
                         justify="center")
    ...
    def fillList():
        ...
        if __name__ == '__main__':
            ...
            def addProduct():
                ...
                product = [pName.get(), pDateOfProduction.get(), pNameOfCustomer.get(), pStorageExpDate.get(),
                           pStorageCode.get(), output_string, pDescription.get()]
                temp = [*product]
                postProduct(temp)

            sfbutton1 = Button(frame2, text="Back", activebackground="grey25", font="Verdana 12", command=firstframe,
                               fg="#1C1C1C", bg="OrangeRed3", relief=FLAT)
            sfbutton1.place(x=20, y=300)

            sfbutton2 = Button(frame2, text="Add Product", activebackground="grey25", font="Verdana 12",
                               command=addProduct,
                               fg="#1C1C1C", bg="OrangeRed3", relief=FLAT)
...
def thirdframe():
    ...
    nameVar = StringVar()
    pName = Label(frame3, width=20, font="Verdana 12 bold", fg="OrangeRed3", bg="grey25", relief=FLAT,
                  textvariable=nameVar)
    pName.place(x=220, y=50)
    dopVar = StringVar()
    pDateOfProduction = Label(frame3, width=20, font="Verdana 12 bold", fg="OrangeRed3", bg="grey25", relief=FLAT,
                              textvariable=dopVar)
    pDateOfProduction.place(x=220, y=80)
    nocVar = StringVar()
    pNameOfCustomer = Label(frame3, width=20, font="Verdana 12 bold", fg="OrangeRed3", bg="grey25", relief=FLAT,
                            textvariable=nocVar)
    pNameOfCustomer.place(x=220, y=110)
    sedVar = StringVar()
    pStorageExpDate = Label(frame3, width=20, font="Verdana 12 bold", fg="OrangeRed3", bg="grey25", relief=FLAT,
                            textvariable=sedVar)
    pStorageExpDate.place(x=220, y=140)
    scVar = StringVar()
    pStorageCode = Label(frame3, width=20, font="Verdana 12 bold", fg="OrangeRed3", bg="grey25", relief=FLAT,
                         textvariable=scVar)
    pStorageCode.place(x=220, y=170)
    dVar = StringVar()
    pDescription = Label(frame3, width=38, height=5, font="Verdana 12 bold", fg="OrangeRed3", bg="grey25", relief=FLAT,
                         textvariable=dVar,
                         wraplength=300, justify="center")
    pDescription.place(x=20, y=230)

    sfbutton1 = Button(frame3, text="Back", activebackground="grey25", font="Verdana 12", command=secondframe,
                       fg="#1C1C1C", bg="OrangeRed3", relief=FLAT)
    ...
    combobox = Combobox(frame3, width=34, height=5,
                        values=(materialNames(material2)))
